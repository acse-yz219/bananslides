      ...
      <header className="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700 px-3 md:px-6 py-2 md:py-3 flex-shrink-0">
        <div className="flex items-center justify-between gap-2 md:gap-4">
          ...
          <div className="flex items-center gap-2 md:gap-4 flex-shrink-0">
            ...
            <span className="text-sm md:text-lg font-semibold hidden lg:inline dark:text-gray-200">编辑页面描述</span>
          </div>
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2 sm:gap-3">
          <div className="flex items-center gap-2 sm:gap-3 flex-1">
            <Button
              ...
              className="flex-1 sm:flex-initial text-sm md:text-base bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white border-none shadow-lg shadow-purple-500/20"
            >
              批量生成描述
            </Button>
        ...
        <div className="max-w-7xl mx-auto">
          {currentProject.pages.length === 0 ? (
            <div className="text-center py-12 md:py-20">
              ...
              <h3 className="text-lg md:text-xl font-semibold text-gray-700 dark:text-gray-200 mb-2">
                还没有页面
              </h3>
