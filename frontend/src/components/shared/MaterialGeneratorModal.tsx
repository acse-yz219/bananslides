    ...
    <Modal isOpen={isOpen} onClose={handleClose} title="素材生成" size="lg">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
          <h4 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">生成结果</h4>
          {isGenerating ? (
            <div className="aspect-video rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700">
              <Skeleton className="w-full h-full" />
            </div>
          ) : previewUrl ? (
            <div className="aspect-video bg-white dark:bg-gray-700 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-600 flex items-center justify-center">
              <img
                src={previewUrl}
                alt="生成的素材"
            ...
            <div className="aspect-video bg-gray-100 dark:bg-gray-900 rounded-lg flex flex-col items-center justify-center text-gray-400 dark:text-gray-500 text-sm">
        ...
        <div className="bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 space-y-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
              <ImagePlus size={16} className="text-gray-500 dark:text-gray-400" />
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <div className="space-y-2">
              ...
              <label className="w-40 h-28 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded flex flex-col items-center justify-center cursor-pointer hover:border-purple-500 dark:hover:border-purple-500 transition-colors bg-white dark:bg-gray-700 relative group">
                {refImage ? (
                  <>
                    <img
                  ...
                  <>
                    ...
                    <span className="text-xs text-gray-500 dark:text-gray-400">点击上传</span>
                  </>
                )}
                <input
                  type="file"
            ...
            <div className="flex-1 space-y-2 min-w-[180px]">
              <div className="text-xs text-gray-600 dark:text-gray-400">额外参考图（可选，多张）</div>
              <div className="flex flex-wrap gap-2">
                ...
                <label className="w-20 h-20 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded flex flex-col items-center justify-center cursor-pointer hover:border-purple-500 dark:hover:border-purple-500 transition-colors bg-white dark:bg-gray-700">
                  <Upload size={18} className="text-gray-400 dark:text-gray-500 mb-1" />
                  <span className="text-[11px] text-gray-500 dark:text-gray-400">添加</span>
                  <input
                    type="file"
                    accept="image/*"
                    multiple
